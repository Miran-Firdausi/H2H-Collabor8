...
class ChatViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAuthenticated]  # Ensure only authenticated users can access chats
    ...
    def send_message(self, request, pk=None):
        ...
        if chat.is_ai_chat:
            ...
            Message.objects.create(chat=chat, sender=ai_user, content=ai_response, is_ai_message=True)
